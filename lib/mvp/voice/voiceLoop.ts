/**
 * Low-latency voice loop — phrase chunker, TTS queue, latency tracker.
 * Browser-side: chunks AI responses into sentences for early TTS.
 */
...
/**
 * Phrase chunker — splits text into sentence-sized chunks for early TTS.
 * Accumulates tokens, emits complete sentences as they arrive.
 */
...
/**
 * TTS queue — plays audio chunks sequentially.
 * Supports barge-in: call cancel() to stop and flush.
 */
