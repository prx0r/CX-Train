...
const CRITERIA_DEFS = [
  ...
  // Kepner-Tregoe
  { key: 'kt_define_problem', label: 'Candidate defined what IS happening vs what IS NOT happening' },
  { key: 'kt_test_causes', label: 'Candidate tested possible causes before jumping to a fix' },
  { key: 'kt_confirm_root_cause', label: 'Candidate confirmed the root cause before fixing' },
  // SERVQUAL
